...
import { isUpdate } from '@openscd/oscd-api/utils.js';
...
describe('SampledValueControl element editor component', () => {
  ...
  it('allows to change the SampledValueControl elements attributes', async () => {
    (editor.sampledValueControlInputs![0] as OscdSclTextField).value =
      'SomeNewName';
    editor.sampledValueControlInputs![1].nullSwitch?.click();
    await editor.updateComplete;

    (editor.sampledValueControlInputs![2] as OscdSclTextField).value = '40001';
    (editor.sampledValueControlInputs![3] as OscdSclTextField).value =
      'someOtherSmvID';
    (editor.sampledValueControlInputs![4] as OscdSclTextField).value = 'SmpPerSec';
    (editor.sampledValueControlInputs![5] as OscdSclTextField).value = '4000';
    (editor.sampledValueControlInputs![6] as OscdSclTextField).value = '2';
    editor.sampledValueControlInputs![7].nullSwitch?.click();
    await editor.updateComplete;

    (editor.sampledValueControlInputs![7] as OscdSclSelect).value = 'None';
